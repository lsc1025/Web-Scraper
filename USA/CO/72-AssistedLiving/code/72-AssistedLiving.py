...
module_name = "72-AssistedLiving"
sys.path.insert(0, os.path.abspath(sys.argv[0][:-len(module_name + ".py")] + "../../../../.."))

from scrapers.pqcq_scrapy.pqcq_scrapy.spiders.CO72AssistedLivingSpider import CO72AssistedLivingSpider
...
process.crawl(CO72AssistedLivingSpider)
process.start()
