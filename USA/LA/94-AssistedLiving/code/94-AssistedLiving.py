...
module_name = "94-AssistedLiving"
sys.path.insert(0, os.path.abspath(sys.argv[0][:-len(module_name + ".py")] + "../../../../.."))

from scrapers.pqcq_scrapy.pqcq_scrapy.spiders.LA94AssistedLivingSpider import LA94AssistedLivingSpider
...
process.crawl(LA94AssistedLivingSpider)
process.start()
