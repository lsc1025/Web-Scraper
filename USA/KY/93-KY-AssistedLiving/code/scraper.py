...
def parse_directory(output_name='output', output_type='csv', file_name='index.html'):
    ...
    head_row = ['Facility Name', 'Facility Type', 'Address1', 'Address2', 'City', 'Zip', 'State', 'Phone', 'Space', 'Country']
    ...
    for dir in dir_list:
        ...
        src = tree.xpath('//div[@id="section1ContentPlaceholderControl"]/p')
