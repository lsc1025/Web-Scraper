...
def parse_pdf(output_name='output', output_type='csv', file_name='index.html', overwrite=True):
    ...
    for dir in dir_list:
        ...
        for item in src:
            ...
            csvrow = []
            data = parse_list(item.xpath('./td/font/text()'))
            if data[1] == last_row:
                print('Resuming...')
                overwrite = True
                continue
