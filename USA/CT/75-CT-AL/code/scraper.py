...
def parse_directory(output_name='output', output_type='csv', file_name='index.html'):
    ...
    head_row = ['Facility Name', 'Address1', 'Address2', 'City', 'Zip', 'State', 'Phone', 'Website', 'Country']
