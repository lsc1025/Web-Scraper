...
def parse_directory(output_name='output', output_type='csv', file_name='output.csv'):
    ...
    for dir in dir_list:
        ...
        input_csv = open('../input/' + dir, 'r')
        input_src = csv.reader(input_csv, delimiter='\r')

        for row in input_src:
            print(row)
