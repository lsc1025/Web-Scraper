...
module_name = "99-NursingHomes"
sys.path.insert(0, os.path.abspath(sys.argv[0][:-len(module_name + ".py")] + "../../../../.."))

from scrapers.pqcq_scrapy.pqcq_scrapy.spiders.ME99NursingHomesSpider import ME99NursingHomesSpider
...
process.crawl(ME99NursingHomesSpider)
process.start()
