...
old_dir = os.getcwd()
module_name = "3-AssistedLiving"

sys.path.insert(0, os.path.abspath(sys.argv[0][:-len(module_name + ".py")] + "../../../../.."))

from scrapers.pqcq_scrapy.pqcq_scrapy.spiders.NL3AssistedLivingSpider import NLAssistedLivingSpider
...
process.crawl(NLAssistedLivingSpider)
process.start()
